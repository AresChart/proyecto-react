 ...
 */
 ...
 import { Text, View, SectionList, Picker} from 'react-native';
 import { styles } from '../styles/styles';
 import ButtonA from '../componentes/ButtonComponent';
 import TextI from '../componentes/TextInputComponent';
 import * as funciones from '../domain/AssignmentAlgorithmsFuntions';
 ...
 const mapaBits = () => {
    ...
    const [algoritmo, setAlgoritmo]                 = React.useState("Indexada-Enlazada");
